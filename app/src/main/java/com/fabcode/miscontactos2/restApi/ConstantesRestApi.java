...
public final class ConstantesRestApi {
    ...
    public static final String KEY_GET_MEDIA_ID = "media/{media-id}/likes";

    public static final String URL_GET_INFORMATION_USER = KEY_GET_RECENT_MEDIA_USER + KEY_ACCESS_TOKEN + ACCESS_TOKEN;
    public static final String URL_GET_MEDIA_ID_LIKES = KEY_GET_MEDIA_ID + KEY_ACCESS_TOKEN + ACCESS_TOKEN;
    ...
    public static final String KEY_POST_ID_TOKEN_INSTAGRAM = "token-device-instagram/";
    public static final String KEY_REGISTRO_INSTAGRAM = "registro-instagram/{id}/{idFoto}/{idUsuario}/";
